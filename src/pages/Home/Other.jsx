                    ...
                    <div className="col-md-6 mb-3">
                        <div className="home-other-card card text-white bg-dark">
                            ...
                            <div className="card-footer">
                                <a className="home-other-btn btn btn-light btn-lg w-100" href="https://github.com/Maseshi" target="_blank" rel="noreferrer" role="button">เข้าไปดู</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 mb-3">
                        <div className="home-other-card card text-dark bg-light">
                            <div className="card-body">
                                <h2 className="card-title">
                                    <i className="bi bi-cash-coin"></i> สนับสนุน
                                </h2>
                            ...
                            <div className="card-footer">
                                <button className="home-other-btn btn btn-dark btn-lg w-100" type="button" data-bs-toggle="modal" data-bs-target="#donateModal">สนับสนุน</button>
                            </div>
                        </div>
                    </div>
                </div>
